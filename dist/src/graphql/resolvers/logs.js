...
exports.default = {
    Query: {
        ...
        todayLogs: (0, auth_1.ensureAuthenticated)((_, { input }, context) => __awaiter(void 0, void 0, void 0, function* () {
            var _c;
            return yield ((_c = context.apis) === null || _c === void 0 ? void 0 : _c.logsAPI.getTodayLogs(input));
        })),
    },
    Mutation: {
        createLog: (0, auth_1.ensureAuthenticated)((_, { input }, context) => __awaiter(void 0, void 0, void 0, function* () {
            var _d;
            return yield ((_d = context.apis) === null || _d === void 0 ? void 0 : _d.logsAPI.createLog(input));
        })),
        updateLog: (0, auth_1.ensureAuthenticated)((_, { input }, context) => __awaiter(void 0, void 0, void 0, function* () {
            var _e;
            return yield ((_e = context.apis) === null || _e === void 0 ? void 0 : _e.logsAPI.updateLog(input));
        })),
        deleteLog: (0, auth_1.ensureAuthenticated)((_, { logId }, context) => __awaiter(void 0, void 0, void 0, function* () {
            var _f;
            return yield ((_f = context.apis) === null || _f === void 0 ? void 0 : _f.logsAPI.deleteLog(logId));
        })),
        resolveLog: (0, auth_1.ensureAuthenticated)((_, { logId }, context) => __awaiter(void 0, void 0, void 0, function* () {
            var _g;
            return yield ((_g = context.apis) === null || _g === void 0 ? void 0 : _g.logsAPI.resolveLog(logId));
        })),
        unresolveLog: (0, auth_1.ensureAuthenticated)((_, { logId }, context) => __awaiter(void 0, void 0, void 0, function* () {
            var _h;
            return yield ((_h = context.apis) === null || _h === void 0 ? void 0 : _h.logsAPI.unresolveLog(logId));
        })),
        addLogToBucket: (0, auth_1.ensureAuthenticated)((_, { logId, bucketId }, context) => __awaiter(void 0, void 0, void 0, function* () {
            var _j;
            return yield ((_j = context.apis) === null || _j === void 0 ? void 0 : _j.logsAPI.addLogToBucket(logId, bucketId));
        })),
        addLogToSequence: (0, auth_1.ensureAuthenticated)((_, { logId, sequenceId, sequenceOrder }, context) => __awaiter(void 0, void 0, void 0, function* () {
            var _k;
            return yield ((_k = context.apis) === null || _k === void 0 ? void 0 : _k.logsAPI.addLogToSequence(logId, sequenceId, sequenceOrder));
        })),
    },
};
